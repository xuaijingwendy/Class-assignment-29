...
>>> import urllib
>>> import urllib2
>>> values={"username":"2018933125@qq.com","password":"15251356767xaj"}
...
<html>
  <head>
    ...
    <link type="text/css" rel="stylesheet" href="/css/bootstrap.css;jsessionid=EDF29B4E079FE46EC6BEC5A654D59F3D.tomcat1" />
    <link type="text/css" rel="stylesheet" href="/css/login.css;jsessionid=EDF29B4E079FE46EC6BEC5A654D59F3D.tomcat1" />
    <link type="text/css" rel="stylesheet" href="/css/weixinqr.css;jsessionid=EDF29B4E079FE46EC6BEC5A654D59F3D.tomcat1" />
  ...
  <body>
            ...
            <div class="login-part">
              ...
              <div class="user-info">
                <div class="user-pass">
                  ...
                  <form id="fm1" action="/account/login;jsessionid=EDF29B4E079FE46EC6BEC5A654D59F3D.tomcat1?from=http://my.csdn.net/my/mycsdn" method="post">
					...
					<input type="hidden" name="lt" value="LT-576033-3V9zpcQnbcCz11Kz5t9zK2gg4Dy153" />
              ...
              <div class="third-part tracking-ad" data-mod="popu_27">
              	...
              	<a id="qqAuthorizationUrl" href="https://graph.qq.com/oauth2.0/authorize?response_type=code&client_id=100270989&redirect_uri=https%3A%2F%2Fpassport.csdn.net%2Faccount%2Flogin%3Foauth_provider%3DQQProvider&state=test" class="qq"></a>
                   	...
                   	<script src="/js/apps/weixinqr.js;jsessionid=EDF29B4E079FE46EC6BEC5A654D59F3D.tomcat1"></script>
                ...
                <div class="register-now"><span>还没有CSDN帐号？</span>
	                <span class="register tracking-ad" data-mod="popu_28">
	                	<a href="/account/mobileregister?action=mobileRegisterGuideView&service=http%3A%2F%2Fmy.csdn.net%2Fmy%2Fmycsdn">立即注册</a>
	                </span>
               	</div>
              </div>
            </div>
    ...
    <script data-main="/js/login-config.js;jsessionid=EDF29B4E079FE46EC6BEC5A654D59F3D.tomcat1" src="/js/libs/require.js;jsessionid=EDF29B4E079FE46EC6BEC5A654D59F3D.tomcat1"></script>
    <script type="text/javascript">
